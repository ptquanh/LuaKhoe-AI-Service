...
{{
  "disease_name": "Tên bệnh bằng tiếng Việt (tên tiếng Anh)",
  "severity_assessment": "Đánh giá mức độ nghiêm trọng dựa trên tài liệu",
  "immediate_actions": ["CHỈ những việc nông dân có thể làm NGAY HÔM NAY trên ruộng đang bệnh"],
  "treatment_protocol": {{
    "chemical": "Thuốc BVTV + khoáng chất vô cơ (bao gồm Silicon/canxi silicat)",
    "biological": "CHỈ chế phẩm từ sinh vật sống (Trichoderma, Bacillus...)",
    "cultural": "Kỹ thuật canh tác (quản lý nước, mật độ, vệ sinh đồng ruộng)"
  }},
...
Độ tin cậy của mô hình nhận diện: {confidence:.1%}
